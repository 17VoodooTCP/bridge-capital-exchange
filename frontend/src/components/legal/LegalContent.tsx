// Single source of truth for the legal copy, shared by the /legal page and the
// Terms modal shown during sign-up.
...
export function TermsContent() {
  return (
    <div className="space-y-3 text-sm text-[#8B949E] leading-relaxed">
      ...
      <p><strong className="text-[#E6EDF3]">4. Deposits &amp; withdrawals.</strong> Withdrawals are subject to identity verification and to the daily limit shown on your account. Requests may be reviewed before processing, and we may request proof of source of funds.</p>
      <p><strong className="text-[#E6EDF3]">5. Prohibited use.</strong> You may not use the platform for unlawful activity, market manipulation, or to circumvent applicable regulations.</p>
      <p><strong className="text-[#E6EDF3]">6. Suspension.</strong> We may restrict or suspend accounts showing unusual or suspicious activity, pending review. Restricted users retain read access and may contact support to resolve the matter.</p>
      <p><strong className="text-[#E6EDF3]">7. No advice.</strong> Bridge Capital does not provide financial, investment, legal, or tax advice. All trading decisions are your own.</p>
      <p><strong className="text-[#E6EDF3]">8. Changes.</strong> We may update these Terms; continued use after changes constitutes acceptance.</p>
    </div>
  );
}
